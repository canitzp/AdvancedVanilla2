...
public class Vanilla { //Version: Minecraft 1.7.10
    ...
    public static void postInit(){
        ...
        AVOreDictionary.AVODBlock("blockFence", Blocks.fence);
        ...
        AVOreDictionary.AVODItem("foodFishCocked", Items.cooked_fished);
        AVOreDictionary.AVODItem("foodSalomonCocked", Items.cooked_fished, 1);
